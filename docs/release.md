...
`zip`. Each archive includes the binary, English and Simplified Chinese
READMEs, documentation, examples, and license so README links and the
quick-start LDIF also work offline.
