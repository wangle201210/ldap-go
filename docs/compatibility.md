...
configuration schema, backend/module-specific mutation hooks, explicit
ordered-sibling ModifyDN parity, and full differential error behavior remain
pending. `X-ORDERED VALUES` attributes are numbered, inserted, deleted,
