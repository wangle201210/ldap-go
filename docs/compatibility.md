...
| Subschema subentry | partial | Publishes attribute/object-class and DIT descriptions plus 32 implemented public matching rules and native-derived matchingRuleUse. Canonical rule-name/OID Compare and filters, operational selection, typesOnly, ACLs, bounded runtime snapshots, and online schema refresh/rollback are covered. Hidden/unimplemented rules are not fabricated; full native syntax/module inventories remain. See [matching-rule discovery](matching-rule-schema.md) |
