...
configuration schema, backend/module-specific mutation hooks, generic
`X-ORDERED SIBLINGS` DN renumbering, and full differential error behavior
remain pending. `X-ORDERED VALUES` attributes are numbered, inserted, deleted,
