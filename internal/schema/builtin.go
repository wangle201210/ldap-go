...
var builtinHiddenAttributeTypes = []string{
	...
	"( 1.3.6.1.4.1.4203.1.12.2.3.0.8 NAME 'olcAuthzRegexp' EQUALITY caseIgnoreMatch SYNTAX " + SyntaxDirectoryString + " X-ORDERED 'VALUES' )",
	"( 1.3.6.1.4.1.4203.1.12.2.3.2.0.11 NAME 'olcSyncrepl' EQUALITY caseIgnoreMatch SYNTAX " + SyntaxDirectoryString + " X-ORDERED 'VALUES' )",
	"( 1.3.6.1.4.1.4203.1.12.2.3.0.9 NAME 'olcBackend' EQUALITY caseIgnoreMatch SYNTAX " + SyntaxDirectoryString + " SINGLE-VALUE X-ORDERED 'SIBLINGS' )",
	"( 1.3.6.1.4.1.4203.1.12.2.3.0.13 NAME 'olcDatabase' SUP olcBackend SINGLE-VALUE X-ORDERED 'SIBLINGS' )",
	"( 1.3.6.1.4.1.4203.1.12.2.3.0.34 NAME 'olcOverlay' SUP olcDatabase SINGLE-VALUE X-ORDERED 'SIBLINGS' )",
	"( 1.3.6.1.4.1.4203.1.12.2.3.0.28 NAME 'olcLogLevel' EQUALITY caseIgnoreMatch SYNTAX " + SyntaxDirectoryString + " )",
