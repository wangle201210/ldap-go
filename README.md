...
The [latest substring replay](docs/performance-optimization-20260923.md) reduces
scan time by about 58% against `205b61b`; it also records remaining bottlenecks.
