...
if [ "$#" -ne 0 ]; then
	die "this script accepts configuration through OPENLDAP_SOURCE, OPENLDAP_SOURCE_CACHE, OPENLDAP_ALLOW_UNVERIFIED_REFERENCE, BUILD, PREFIX, JOBS, OPENSSL_PREFIX, CYRUS_SASL_PREFIX, LIBEVENT_PREFIX, and OPENLDAP_ENV_FILE"
fi
