...
最新常用功能对照：2026-09-24，100,000 个用户，Apple M1 Pro，Go 禁用 cgo，
...
| --- | ---: | ---: | ---: | ---: | ---: |
| 用户 Bind，SSHA | 1,000 | 104.47 ms | 71.46 ms | 68.4% | 66.4% |
| 非管理员 Base，热点用户 | 1,000 | 110.81 ms | 77.32 ms | 69.8% | 54.3% |
| 非管理员索引查询，热点用户 | 1,000 | 110.49 ms | 78.98 ms | 71.5% | 54.4% |
| 直接所属组查询 | 100 | 43.54 ms | 16.99 ms | 39.0% | 4.5% |
| 读取千人成员组 | 100 | 86.44 ms | 79.73 ms | 92.2% | 18.5% |
| 嵌套组，客户端 BFS | 100 次遍历 | 97.21 ms | 55.30 ms | 56.9% | 12.6% |

[常用功能报告](docs/common-ldap-performance.md)包含分散用户查询、准确 ACL 配置、
原始样本和验证记录；[SDK 对照工具](internal/cmd/ldapcommonbench/README.md)
可对临时服务复跑。四项追平目标**尚未完成**，显式 ACL 的用户组查询仍是最大差距。
密码强度和权限判断均保持原有行为。
