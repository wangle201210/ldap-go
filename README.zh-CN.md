...
| --- | ---: | ---: | ---: |
| 导入并建立索引 | 105,727 ms | 832,618 ms | 788% |
| 启动至就绪 | 272 ms | 96 ms | 35% |
| 索引查询，重复批次 | 720 ms | 608 ms | 84% |
| 索引查询，首批 | 1,953 ms | 617 ms | 32% |
| 无索引负查询，重复批次 | 30 ms | 338 ms | 1,127% |
| 无索引负查询，首批 | 1,016 ms | 390 ms | 38% |
| 分页全量遍历，重复批次 | 718 ms | 1,543 ms | 215% |
| 分页全量遍历，首次 | 2,012 ms | 715 ms | 36% |
| 并发索引查询 | 258 ms | 275 ms | 107% |
| Modify | 565 ms | 3,780 ms | 669% |
| 工作负载结束后的 RSS | 462.7 MiB | 93.6 MiB | 20% |
| 空闲 10 秒后的 RSS | 207.2 MiB | 89.7 MiB | 43% |
| 数据库文件 | 118.1 MiB | 81.3 MiB | 69% |
