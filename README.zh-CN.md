...
| --- | ---: | ---: | ---: |
| 导入并建立索引 | 101,085 ms | 876,070 ms | 0.12 |
| 启动至就绪 | 261 ms | 89 ms | 2.93 |
| 索引查询，重复批次 | 680 ms | 554 ms | 1.23 |
| 索引查询，首批 | 4,073 ms | 642 ms | 6.34 |
| 无索引负查询，重复批次 | 32 ms | 336 ms | 0.10 |
| 无索引负查询，首批 | 1,036 ms | 350 ms | 2.96 |
| 分页全量遍历，重复批次 | 741 ms | 900 ms | 0.82 |
| 分页全量遍历，首次 | 3,876 ms | 450 ms | 8.61 |
| 并发索引查询 | 202 ms | 201 ms | 1.00 |
| Modify | 572 ms | 5,420 ms | 0.11 |
| 工作负载结束后的 RSS | 773.5 MiB | 93.6 MiB | 8.26 |
| 空闲 10 秒后的 RSS | 700.3 MiB | 92.8 MiB | 7.55 |
