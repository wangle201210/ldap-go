...
| --- | ---: | ---: | ---: |
| 导入并建立索引 | 165,692 ms | 961,340 ms | 0.17 |
| 启动至就绪 | 319 ms | 93 ms | 3.43 |
| 索引查询，重复批次 | 810 ms | 605 ms | 1.34 |
| 索引查询，首批 | 4,280 ms | 550 ms | 7.78 |
| 无索引负查询，重复批次 | 42 ms | 351 ms | 0.12 |
| 无索引负查询，首批 | 1,047 ms | 472 ms | 2.22 |
| 分页全量遍历，重复批次 | 750 ms | 1,402 ms | 0.53 |
| 分页全量遍历，首次 | 4,152 ms | 726 ms | 5.72 |
| 并发索引查询 | 255 ms | 237 ms | 1.08 |
| Modify | 1,032 ms | 4,299 ms | 0.24 |
| 工作负载结束后的 RSS | 406.2 MiB | 92.4 MiB | 4.40 |
| 空闲 10 秒后的 RSS | 266.4 MiB | 92.4 MiB | 2.88 |
